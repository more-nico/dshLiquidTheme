window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const ZH = {
      ...
      wallTitle: "背景图",
      wallHint: "默认是内置的深海虎鲸图。也可以填图片地址、选本地图，或指定纯色。本地 / 网络图都会压进浏览器本地，刷新不再重新下载。",
      colorTitle: "纯色背景",
    ...
    const EN = {
      ...
      wallTitle: "Wallpaper",
      wallHint: "The built-in orca wallpaper is the default. Paste an image URL, pick a file, or set a solid color. Local and remote images are stored in the browser so reloads stay instant.",
