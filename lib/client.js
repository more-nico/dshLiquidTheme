window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const ZH = {
      ...
      scrimTitle: "内容垫层透明度",
      scrimHint: "对准主会话列。中间最实，从会话左右再往外 20% 淡到全透明。",
      scrimBlurTitle: "内容垫层模糊",
      scrimBlurHint: "同一条垫层的模糊，中间最糊，两边同样淡到没有。",
      apply: "应用",
      choose: "选择图片",
      reset: "恢复默认",
    ...
    const EN = {
      ...
      scrimHint: "Centered on the transcript. Solid in the middle, clear 20% past each side of that column.",
      scrimBlurTitle: "Reading pad blur",
      scrimBlurHint: "Same pad, strongest blur in the middle, fading out with the fill.",
      apply: "Apply",
      choose: "Choose image",
      reset: "Reset",
