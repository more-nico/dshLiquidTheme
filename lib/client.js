window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const TOKENS = {
      ...
      "--dsw-specific-sidebar-fill": pair("rgba(255,255,255,0.22)", "rgba(12,14,20,0.26)"),
      ...
      "--dsw-specific-input-major": pair("rgba(255,255,255,0.32)", "rgba(22,24,32,0.36)"),
    ...
    function mountLayers(el) {
      if (!el || el.querySelector(":scope > .dsh-lg-effect")) return;
    ...
    function apply(ctx) {
      ...
      ctx.effect(() => {
        ...
        const observer = new MutationObserver(() => decorateChrome());
