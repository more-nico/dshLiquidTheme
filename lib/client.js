window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const TOKENS = {
      ...
      "--dsw-alias-bg-layer-2": pair("rgba(255,255,255,0.54)", "rgba(28,30,40,0.52)"),
      "--dsw-alias-bg-layer-3": pair("rgba(255,255,255,0.62)", "rgba(36,38,50,0.58)"),
      "--dsw-alias-bg-overlay": pair("rgba(255,255,255,0.58)", "rgba(30,32,42,0.62)"),
      ...
      "--dsw-specific-menu": pair("rgba(255,255,255,0.62)", "rgba(28,30,40,0.62)"),
